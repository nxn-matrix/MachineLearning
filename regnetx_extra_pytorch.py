...
if (REGNETX == "custom"):
  print("Model selected = Regnetx custom")
...
if (REGNETX == "200mf"):
  print("Model selected = Regnetx 200MF")
  MODEL_TAIL_OUT_CHANNELS  = 24
  MODEL_BLOCKS             = [1,1,4,7]
...
#400MF (512 batch size, 72.5% acc, max LR = 0.01, Epochs = 60)
if (REGNETX == "400mf"):
  print("Model selected = Regnetx 400MF")
  MODEL_TAIL_OUT_CHANNELS  = 24
  MODEL_BLOCKS             = [1,2,7,12]
  MODEL_CHANNELS           = [32,64,160,384]
  MODEL_GROUP_WIDTH        = 16
  MODEL_FILTER_SIZE        = 3
  DATA_BATCH_SIZE          = 512

if (REGNETX == "600mf"):
  print("Model selected = Regnetx 600MF")
  MODEL_TAIL_OUT_CHANNELS  = 48
  MODEL_BLOCKS             = [1,3,5,7]
  MODEL_CHANNELS           = [48,96,240,528]
  MODEL_GROUP_WIDTH        = 24
  MODEL_FILTER_SIZE        = 3
  DATA_BATCH_SIZE          = 256

if (REGNETX == "800mf"):
  print("Model selected = Regnetx 800MF")
  MODEL_TAIL_OUT_CHANNELS  = 56
  MODEL_BLOCKS             = [1,3,7,5]
  MODEL_CHANNELS           = [64,128,288,672]
  MODEL_GROUP_WIDTH        = 16
  MODEL_FILTER_SIZE        = 3
  DATA_BATCH_SIZE          = 256
...
#1.6GF
if (REGNETX == "1600mf"):
  print("Model selected = Regnetx 1.6GF")
  MODEL_TAIL_OUT_CHANNELS  = 80
  MODEL_BLOCKS             = [2,4,10,2]
  MODEL_CHANNELS           = [72,168,408,912]
  MODEL_GROUP_WIDTH        = 24
  MODEL_FILTER_SIZE        = 3
